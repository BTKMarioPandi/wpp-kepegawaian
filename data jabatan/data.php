  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Data Jabatan Imam Hazwa </li>
      </ol>
      ...
      <a href="exportpdf.php" class="btn btn-info btn-sm"><i class="fa fa-file-excel-o"> &nbsp;Exsport With PDF</i></a>
        ...
        <a href="add.php" class="btn btn-info btn-sm m-b-10"><i class="fa fa-file-plus-circle"> &nbsp;Tambah Jabatan</i></a>
        </div>
          ...
          <div class="table-responsive">
              <table id="t_jabatan" class="table table-borde19d5fd table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Jabatan</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">No sk</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Sk mulai jabatan</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Sk berakhir</th>
                ...
                <tbody>
                  ...
                  $sql_pegawai = mysqli_query($con, "SELECT * FROM t_jabatan095
                        ...
                        INNER JOIN t_master_jabatan095 ON t_jabatan095.id_m_jabatan095 = t_master_jabatan095.id_m_jabatan095 ") or die (mysqli_error($con));
                ...
                <tr>
                  ...
                  <td><img src="../_assets/img_jabatan/<?= $data['file_sk095'] ?>" width='100'></td>
                  <td class="text-center">
                    <a href="edit.php?id=<?=$data['id_jabatan095']?>" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                    <a href="delete.php?id=<?=$data['id_jabatan095']?>" onclick="return confirm ('Yakin Mau Di Hapus?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                  </td>
                </tr>
                <?php
              }
