...
//$target_file = $target_dir . basename($_FILES["photo"]["name"]);
	...
	$nama 			= trim(mysqli_real_escape_string($con, $_POST['nama_golongan']));

if(isset($_POST['add'])){
	mysqli_query($con, "INSERT INTO t_golongan(id_golongan,nama_golongan)VALUES ('$uuid','$nama')") or die (mysqli_error($con));
