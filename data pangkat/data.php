...
include_once('nav.php')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Data Pangkat Imam Hazwa
        
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Data Pangkat Ipedeni Charitian Harita</li>
      </ol>
      ...
      <a href="exportpdf.php" class="btn btn-info btn-sm"><i class="fa fa-file-excel-o"> &nbsp;Exsport With PDF</i></a>
        ...
        <a href="add.php" class="btn btn-info btn-sm m-b-10"><i class="fa fa-file-plus-circle"> &nbsp;Tambah Pangkat</i></a>
        </div>
          ...
          <div class="table-responsive">
              <table id="t_jabatan" class="table table-borde19d5fd table-striped">
                ...
                <tr>
                  ...
                  <th class="text-center" bgcolor="19d5fd"><font color="black">M Pegawai</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Golongan</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">No SK</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Tgl SK</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Tgl Mulai</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">Tgl Akhir</th>
                  <th class="text-center" bgcolor="19d5fd"><font color="black">File SK</th>
                ...
                <tr>
                  ...
                  <td><img src="../_assets/img_pangkat/<?=$data['file_sk']?>" width='100'></td>
                  <td class="text-center">
                    <a href="edit.php?id=<?=$data['id_pangkat']?>" class="btn btn-info btn-xs"><i class="glyphicon glyphicon-edit"></i></button>
                    <a href="delete.php?id=<?=$data['id_pangkat']?>" onclick="return confirm ('Yakin Mau Di Hapus?')" class="btn btn-danger btn-xs"><i class="glyphicon glyphicon-trash"></i></button>
                  </td>
                </tr>
                <?php
              }
