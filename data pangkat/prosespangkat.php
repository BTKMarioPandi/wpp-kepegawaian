...
//$target_file = $target_dir . basename($_FILES["photo"]["name"]);
	...
	$nama 			= trim(mysqli_real_escape_string($con, $_POST['nama_pangkat']));

if(isset($_POST['add'])){
	mysqli_query($con, "INSERT INTO t_master_pangkat(id_m_pangkat,nama_pangkat)VALUES ('$uuid','$nama')") or die (mysqli_error($con));
