...
include_once('nav.php')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <div class="pull-right">
        ...
        <a href="add.php" class="btn btn-info btn-sm m-b-10"><i class="fa fa-file-plus-circle"> &nbsp;Tambah Pegawai</i></a>
        </div>
        ...
        <div class="box box-success box-solid">
          ...
          <div class="table-responsive">
              <table id="t_pegawai095" class="table table-bordered table-striped">
                <thead>
                <tr>
            ...
            <th class="text-center" bgcolor="#19d5fd"><i class="glyphicon glyphicon-cog"></th>
                ...
                <tbody>
                  <?php
                  $no = 1;
                  $sql_pegawai = mysqli_query($con, "SELECT * FROM t_pegawai095 ORDER BY nik095 DESC") or die (mysqli_error($con));
                ...
                <tr>
                  ...
                  <td><img src="../_assets/img_pegawai/<?= $data['photo095'] ?>" width='100'></td>
                  <td class="text-center">
                    <button class="btn btn-info btn-xs" onclick="edit()" name="tedit" value="<?= $data['id_pegawai095']?>"><i class="glyphicon glyphicon-edit"></i></button>
                    <button class="btn btn-danger btn-xs" onclick="hapus()" name="thapus" value="<?= $data['id_pegawai095']?>"><i class="glyphicon glyphicon-trash"></i></button>
                  </td>
                </tr>
                <?php
              }
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright <a href="https://g.co/kgs/mSKpua">Ipedeni Christian Harita</a>.</strong> All rights reserved.
  </footer>
  <!-- jQuery 3 -->
